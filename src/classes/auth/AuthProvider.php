...
class AuthProvider {
    ...
    {
        if (!isset($_POST['email'],$_POST['nomU'],$_POST['prenomU'], $_POST['password'], $_POST['carteB'], $_POST['password2'])) {
            return "<div class='message-info'>Manque de données.</div>";
        }

        $email = filter_var($_POST['email'], FILTER_SANITIZE_EMAIL);
        $prenom = filter_var($_POST['prenomU'], FILTER_SANITIZE_STRING);
        $nom = filter_var($_POST['nomU'], FILTER_SANITIZE_STRING);
